...
if __name__ == "__main__" :
	...
	givenDay = Label(gui, text = "Given Day", bg = "Grey")

	# Create a Given Month : label
	givenMonth = Label(gui, text = "Given Month", bg = "Grey")

	# Create a Given Year : label
	givenYear = Label(gui, text = "Given Year", bg = "Grey")
	...
	clearAllEntry = Button(gui, text = "Developer :- Diptimayee Swain", fg = "Red", bg = "Yellow")
